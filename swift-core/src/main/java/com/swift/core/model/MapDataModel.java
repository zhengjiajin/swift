...
public class MapDataModel extends LinkedHashMap<String, Object> implements DataModel {
	...
	/**
	 * @see DataModel#addObject(java.lang.String,
	 *      java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see DataModel#putObject(java.lang.String,
	 *      java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see DataModel#getObject(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see DataModel#getList(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see DataModel#getString(java.lang.String)
	 */
	...
	public String getString(String objectPath) {
		...
		if (value instanceof List) {
			return DataModelUtil.objToString(((List) value).get(0));
		}
		if (value instanceof Map) {
			try {
				return ObjectMapperFactory.getObjectMapper().writeValueAsString(value);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
		return DataModelUtil.objToString(value);
	}

	/**
	 * @see DataModel#getLong(java.lang.String)
	 */
	@SuppressWarnings("rawtypes")
	@Override
	public Long getLong(String objectPath) {
		...
		if (value instanceof List) {
			...
			return DataModelUtil.objToLong(o);
		}
		return DataModelUtil.objToLong(value);
	}

	/**
	 * @see DataModel#getInteger(java.lang.String)
	 */
	@SuppressWarnings("rawtypes")
	@Override
	public Integer getInteger(String objectPath) {
		...
		if (value instanceof List) {
			...
			return DataModelUtil.objToInt(o);
		}
		return DataModelUtil.objToInt(value);
	}

	/**
	 * @see DataModel#getFloat(java.lang.String)
	 */
	@SuppressWarnings("rawtypes")
	@Override
	public Float getFloat(String objectPath) {
		...
		if (value instanceof List) {
			...
			return DataModelUtil.objToFloat(o);
		}
		return DataModelUtil.objToFloat(value);
	}

	/**
	 * @see DataModel#getDouble(java.lang.String)
	 */
	@SuppressWarnings("rawtypes")
	@Override
	public Double getDouble(String objectPath) {
		...
		if (value instanceof List) {
			...
			return DataModelUtil.objToDouble(o);
		}
		return DataModelUtil.objToDouble(value);
	}

	/**
	 * @see DataModel#getListString(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see DataModel#getListInteger(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see DataModel#getListDouble(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see DataModel#getListFloat(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see DataModel#remove(java.lang.String)
	 */
	@Override
	...
	@SuppressWarnings("rawtypes")
	public static MapDataModel beanToMap(AbstractBeanDataModel beanData) throws Exception {
		if (beanData == null) {
			return null;
		}
	...
	/**
	 * @see DataModel#getDataModel(java.lang.String)
	 */
	@SuppressWarnings("rawtypes")
	@Override
	...
	/**
	 * @see DataModel#getBoolean(java.lang.String)
	 */
	@SuppressWarnings("rawtypes")
	@Override
	public Boolean getBoolean(String objectPath) throws RuntimeException {
		...
		if (value instanceof List) {
			...
			return DataModelUtil.objToBoolen(o);
		}
		return DataModelUtil.objToBoolen(value);
	}

	/**
	 * @see DataModel#getListBoolean(java.lang.String)
	 */
	@Override
